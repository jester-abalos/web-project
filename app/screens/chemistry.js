        ...
        <View style={styles.container}>
            <ScrollView>
                ...
                <View style={[styles.paragraphContainer, { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', marginBottom: 20, marginTop: 20 }]}>
                    <Text style={{ fontSize: 40, fontWeight: 'bold', left: 100, marginTop: 67, fontFamily: 'Poppins-ExtraBold' }}>CHEMISTRY</Text>
                    <Image source={require('../assets/img/chemistry.png')} style={[styles.image, { resizeMode: 'contain', width: '20%', alignSelf: 'flex-end', right: 220 }]} />
